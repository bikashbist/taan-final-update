...
class PostCategoryController extends DM_BaseController
{
    protected $panel = 'Post Category';
    protected $base_route = 'admin.postcategory';
    protected $view_path = 'admin.postcategory';
    protected $model;
    protected $table;
    protected $folder_path_image;
    protected $folder_path_file;
    protected $folder = 'postcategory';
    protected $prefix_path_image = '/upload_file/postcategory/';
    ...
    public function storeOrder(Request $request)
    {
        if ($request->ajax()) {
            ...
            foreach ($readbleArray as $row) {
                $i++;
                $category = PostCategory::findOrFail($row['id']);
                $category->order = $i;
