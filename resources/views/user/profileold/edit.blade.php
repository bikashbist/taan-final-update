            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.user_profile.update', ['id' => $data['profile']->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.user_profile.passwordChange', ['id' => $data['profile']->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
