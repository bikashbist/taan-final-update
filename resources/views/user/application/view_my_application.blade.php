        ...
        <div class="tab-pane fade show active" id="pills-one" role="tabpanel" aria-labelledby="pills-one-tab">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <hr>
                    <div class="buttons">
                        <a class="btn btn-warning btnPrevious" href="{{ route('user.application.edit_student_document', ['unique_id' => $data['unique_id']])}}"> <i class="fa fa-eye"></i> Preview</a> &nbsp;
                        <a class="btn btn-success" href="{{ route('user.application.index', ['unique_id' => $data['unique_id']])}}"> <i class="fa fa-paper-plane"></i> Submit</a> &nbsp;
                    </div>
