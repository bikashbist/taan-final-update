...
<div class="inner-banner ">
    <!-- <img src="{{asset('user/')}}images/trail/title-bg.jpg" alt="img"> -->
    ...
    <div class="inner-banner__navbar d-flex align-items-center">
        <div class="container position-relative">
            <div class="bg-breadcrumd w-75">
                <h1 class="text-white mb-3">Everest Base Camp <br> Helicopter Tour</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb ">
                        <li class="breadcrumb-item "><a class="text-white" href="#">Home</a></li>
                        <li class="breadcrumb-item "><a class="text-white" href="#">Trail</a></li>
                        <li class="breadcrumb-item text-white" aria-current="page">Everest Base Camp Helicopter Tour
                        </li>
                    </ol>
                </nav>
            </div>
            <div class="quick-view d-flex align-items-center">
                ...
                <div class="quick-detail ">
                    <a href="#related-packages"><i class="fa-brands fa-hive"></i> Total Packages <br> <span>20 Package</span></a>
                </div>
            </div>
        ...
        <div class="row g-5">
                ...
                <div class="main-content__details">
                   <div class="trail-details">
                        ...
                        <div class=" page_content">
                            <blockquote>
                                <p>This sanctuary on a lagoon is virtually the same as it was six hundred years ago, which adds to the fascinating character.</p>
                            </blockquote>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="itinery__item">
                                            ...
                                            <a class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#dayone"
                                                aria-expanded="false" aria-controls="dayone">
                                ...
                                <div class="row g-2">
                                    <div class="col-lg-4">
                                        <a data-fancybox="gallery" data-src="https://lipsum.app/id/3/1600x1200">
                                            <img src="https://lipsum.app/id/3/200x150" width="100%" height="150"
                                                alt="img" />
                                        </a>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <a data-fancybox="gallery" data-src="https://lipsum.app/id/4/1600x1200">
                                            <img src="https://lipsum.app/id/4/200x150" width="100%" height="150"
                                                alt="img" />
                                        </a>
                                    </div>
                                    <div class="col-lg-4">
                                        <a data-fancybox="gallery" data-src="https://lipsum.app/id/2/1600x1200"
                                            data-caption="Optional caption,&lt;br /&gt;that can contain &lt;em&gt;HTML&lt;/em&gt; code">
                                            <img src="https://lipsum.app/id/2/200x150" width="100%" height="150"
                                                alt="img" />
                                        </a>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card">
                                            <a data-fancybox href="https://www.youtube.com/watch?v=CGgAyFwcNKg">
                                              <img class="card-img-top img-fluid" src="http://img.youtube.com/vi/_sI_Ps7JSEk/mqdefault.jpg" alt="img" />
                                            </a>
                                          </div>
                                    </div>
                                    <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="main-content__sidebar  sidebar ">
                            ...
                            <div class="contact-details text-center mt-3 px-4 pb-4">
                                ...
                                <div class="more-infor  p-4 mt-3">
                                    ...
                                    <a class="d-block website-visit" href="#"> <span><i
                                            ...
                                            class="fa-solid fa-arrow-right-long"></i></a>
                                    <p>For more info visit our website</p>
                    ...
                    <div class="sidebar-package-overview sidebar-border">
                        <h3> Photo Gallery</h3>
                        <div class="p-4 trail-gallery">
                            <dic class="row g-2">
                                <div class="col-4">
                                    <a target="_blank" href="#"><img src="{{asset('user/images/trail/1.webp')}}" alt="Buddha Sunrise in Borobudur, Magelang, Central Java, Indonesia" width="75" height="75"></a>

                                </div>
                                <div class="col-4">
                                    <a target="_blank" href="#"><img src="{{asset('user/images/trail/2.webp')}}" alt="Buddha Sunrise in Borobudur, Magelang, Central Java, Indonesia" width="75" height="75"></a>

                                </div>
                                <div class="col-4">
                                    <a target="_blank" href="#"><img src="{{asset('user/images/trail/3.webp')}}" alt="Buddha Sunrise in Borobudur, Magelang, Central Java, Indonesia" width="75" height="75"></a>
                    ...
                    <div class="col-lg-4">
                        <div class="trail-packages__card">
                            ...
                            <div class="portfolio_info_wrapper">
                                <a class="tour_link" href="#"><h4>Everest Base Camp Helicopter Tour</h4></a>
                                ...
                                <div class="tour_attribute_wrapper d-flex justify-content-between align-items-center mt-3">
                                    <div class="tour_attribute_share">
                                        <a id="single_tour_share_button" href="#" class="button ghost themeborder" style="width:auto;"><i class="fa-solid fa-share-nodes"></i> Share this tour</a>
                                    </div>
