        ...
        <div class="container py-lg-5">
            <div class="row">
                <div class="col-lg-7 col-md-10 col-12 mx-auto">
                    <h3 class="text-center text-white py-lg-4 py-3">{{ $data['subcategory']->name }} Members</h3>
                    <h5 class="text-center text-white member-filter-title mb-3">
                        {{ $data['subcategory']->memberType->title }}</h5>
                    <input type="hidden" value="{{ $data['subcategory']->member_type_id }}" id="member-type-id">
                ...
                @else
                    <div class="col-12 text-center py-5">
                        <div class="alert alert-info">
                            ...
                            <p>There are currently no members in the {{ $data['subcategory']->name }} subcategory.</p>
                        </div>
                    </div>
                @endif
            </div>
