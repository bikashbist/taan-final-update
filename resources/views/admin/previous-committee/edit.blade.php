                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" name="title" id="title" value="@if(isset($data['row']->title)) {{ $data['row']->title   }} @endif" placeholder="Achievement Name">
                            </div>

                            <div class="form-group">
                                <div class="form-group" style="font-weight: bold;"><label>Description (<span style="color:red">*</span>)</label>
                                    <textarea name="description" id="my-editor" style=".rte-modern.rte-desktop.rte-toolbar-default {  min-width: 626px;}" cols="30" rows="5" class="form-control rounded" value="">{{ $data['row']->description   }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
