...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route($_base_route.'.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> Create New User</a>
    </div>
            ...
            <table class="table" id="example-table" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.admin_users.edit', ['id' => $row->id])}}" data-original-title="Edit" data-toggle="tooltip" class="btn btn-warning btn-xs">
