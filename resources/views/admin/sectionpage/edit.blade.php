                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <select name="position" class="form-control">
                                        ...
                                        <option value="our-services" @if($data['rows']->position == 'our-services') selected @endif>Our Services</option>
                                        <option value="about" @if($data['rows']->position == 'about') selected @endif>About</option>
                                    </select>
