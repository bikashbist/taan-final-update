                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Student Name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="position" id="position" value="{{ old('position') }}" placeholder="Position ">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="my-editor-1" cols="30" rows="5" class="form-control rounded" value="" placeholder="Student Description ">{{ old('description') }}</textarea>
                                    @if($errors->has('title'))
