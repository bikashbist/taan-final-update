                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" value="@if(isset($data['rows']->name)) {{ $data['rows']->name   }} @endif" placeholder="Student Name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="my-editor-1" cols="30" rows="5" class="form-control rounded" value="" placeholder="Student Description ">@if(isset($data['rows']->description )) {{ $data['rows']->description   }} @endif</textarea>
                                    @if($errors->has('description'))
                                    <p id="name-error" class="help-block " for="site_email"><span>{{ $errors->first('description') }}</span></p>
                                    @endif
                                </div>
                                <div class="form-group col-md-12">
