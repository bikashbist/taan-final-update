                            ...
                            <div class="ibox-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title"
                                        ...
                                        id="title" placeholder="Member Type">
                                    @if ($errors->has('title'))
                                        <p id="name-error" class="help-block " for="site_email">
                                            <span>{{ $errors->first('title') }}</span></p>
                                    @endif
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="ui-checkbox">
                                                <input type="hidden" name="status" value=0><span
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="ui-checkbox">
                                                <input type="hidden" name="has_subcategory" value=0><span
                                                    class="input-span"></span>
                                                <input type="checkbox" name="has_subcategory" value=1
                                                    @if ($data['rows']->has_subcategory) {{ 'checked' }} @endif><span
                                                    class="input-span"></span>
                                            </label>
                                        </div>
                                    </div>
