                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Program Name">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="age" id="age" value="{{ old('age') }}" placeholder="1.5 - 2.5 Year">
                                @if($errors->has('age'))
                                <p id="name-error" class="help-block " for="site_email"><span>{{ $errors->first('age') }}</span></p>
                                @endif
                            </div>
                            <div class="form-group">
