                        ...
                        <form action="{{ route($_base_route . '.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <input class="form-control rounded" type="text" name="trail_address"
                                        id="trail_address" value="{{ old('trail_address') }}" placeholder="Trail Address">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <input class="form-control rounded" type="text" name="duration" id="duration"
                                        value="{{ old('duration') }}" placeholder="Durations">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <input class="form-control rounded" type="text" name="activities" id="activities"
                                        value="{{ old('activities') }}" placeholder="Activities">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <input class="form-control rounded" type="text" name="max_altitude" id="max_altitude"
                                        value="{{ old('max_altitude') }}" placeholder="Max.altitude">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <input class="form-control rounded" type="text" name="group_size" id="group_size"
                                        value="{{ old('group_size') }}" placeholder="Group Size">
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    <label for="child_category_id" style="font-weight: bold;">Trail Chaild Category (<span
                                            style="color:red">*</span>)</label>
                                    <select name="child_category_id[]" class="form-control child_category_id"
                                        multiple="" id="child_category_id">
                                        @if (isset($data['category']) && $data['category']->count() > 0)
                                            @foreach ($data['category'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('category_id') == $row->id ? 'selected' : '' }}>
                                    ...
                                    <select name="difficult_id" class="form-control difficult_id select_category"
                                        ...
                                        @if (isset($data['difficulty']) && $data['difficulty']->count() > 0)
                                            @foreach ($data['difficulty'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('difficult_id') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select name="experience_id" class="form-control difficult_id select_category"
                                        ...
                                        @if (isset($data['experience']) && $data['experience']->count() > 0)
                                            @foreach ($data['experience'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('experience_id') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select name="culture_id" class="form-control difficult_id select_category"
                                        ...
                                        @if (isset($data['culture']) && $data['culture']->count() > 0)
                                            @foreach ($data['culture'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('culture_id') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select name="destination_id" class="form-control difficult_id select_category"
                                        ...
                                        @if (isset($data['destination']) && $data['destination']->count() > 0)
                                            @foreach ($data['destination'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('destination_id') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select name="transport_id" class="form-control difficult_id select_category"
                                        ...
                                        @if (isset($data['transport']) && $data['transport']->count() > 0)
                                            @foreach ($data['transport'] as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('transport_id') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->title }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="form-group col-md-3 col-12 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label class="ui-checkbox">
                                            ...
                                            <input type="checkbox" name="status" value=1><span
                                    ...
                                    <div class="form-group">
                                        <label class="ui-checkbox">
                                            <input type="hidden" name="featured" value=0><span
                                                class="input-span"></span>
                                            <input type="checkbox" name="featured" value=1><span
                                                class="input-span"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 col-12 col-lg-12">
                                    ...
                                    <textarea name="description" id="my-editor" cols="30" id="contet" rows="9"
                                        class="form-control rounded description my-editor">{{ old('description') }}</textarea>
                            ...
                            <div class="ibox-body">
                                <div class="panel-body">
                                    ...
                                    @else
                                        <div class="form-group video">
                                            <div class="input-group control-group increment-days video">
                                                <input type="url" class="form-control rounded" name="video_link[]"
                                                    placeholder="Video Link"><br>
                                                <button class="btn btn-success btn-video btn-sm" type="button"><i
                                                        class="fa fa-plus fa-sm text-white-50"></i> Add</button>
                                            </div>
                            ...
                            <div class="form-group col-md-12 col-12 col-lg-12">
                                ...
                                <input name="meta_tag" id="tagsinput" class="tagsinput form-control"
                                    value="{{ old('meta_tag') }}" placeholder="Meta Tag" />
