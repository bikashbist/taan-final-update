        ...
        <form action="{{ route($_base_route.'.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Add Cultural</div>
                        ...
                        <div class="ibox-body ">
                            <div class="form-group col-md-9">
                                <label for="title">Cultural Title</label>
                                <input class="form-control" type="text" name="title" value="" id="title" placeholder="Cultural Name">
                                @if($errors->has('title'))
