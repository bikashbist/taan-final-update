                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="happy_student" id="happy_student" value=" {{ $data['rows']->happy_student   }} " placeholder="Happy Students">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="teacher" id="teacher" value="{{ $data['rows']->teacher   }}" placeholder="Teachers">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="years" id="years" value="{{ $data['rows']->years   }}" placeholder="Years of Operation">
                                    @if($errors->has('years'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="community" id="community" value="{{ $data['rows']->community   }}" placeholder="Community Served">
