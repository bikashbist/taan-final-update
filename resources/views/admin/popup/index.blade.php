                            ...
                            <tbody>
                                @foreach ($data['rows'] as $key => $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->url }}</td>
                                        <td>
                                            <img src="{{ asset($row->image) }}" class="img img-responsive" height="100px"
                                                width="120px" alt="{{ $row->title }}" title="{{ $row->title }}">
                                        </td>
                                        <td>
                                            <a href="{{ URL::route($_base_route . '.edit', ['id' => $row->id]) }}"><button
                                                    type="button" data-original-title="Edit" data-toggle="tooltip"
                                                    class="btn btn-warning btn-sm" style="cursor:pointer;"><i
