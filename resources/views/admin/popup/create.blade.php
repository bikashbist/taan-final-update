...
@section('title')
    Admin {{ $_panel }} Create | SCMS
@endsection
@section('styles')
    <!-- PLUGINS STYLES-->
    <link href="{{ asset('assets/cms/plugin/nepali.datepicker.v3.7/css/nepali.datepicker.v3.7.min.css') }}"
        rel="stylesheet" />
...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4  text-primary">{{ $_panel }} Create</h1>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            @if ($errors->has('title'))
                                <p id="name-error" class="help-block " for="site_email">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="file" name="image" id="title" value=""
                                placeholder="Product Url" accept="image/png, image/gif, image/jpeg">
                            @if ($errors->has('image'))
                                <p id="name-error" class="help-block " for="site_email">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="ui-checkbox">
                                    ...
                                    <input type="checkbox" name="status" value=1><span class="input-span"></span> Status
                                </label>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/cms/plugin/nepali.datepicker.v3.7/js/nepali.datepicker.v3.7.min.js') }}"
